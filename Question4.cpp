...
int ConcatERemove(char *s,char *t, int k)
{
    ...
    if (iSizeString1 > iSizeString2)
    {
        ...
        if (((iSizeString1-iEqualEnd ==iDiference )) ||   ((((iSizeString1-iEqualEnd)*2)+iDiference) <= k)|| (((iSizeString1-iEqualEnd)*2)-1)==k)
        {
            iResult = 1;  
        }
    }
    ...
    if (iSizeString1 < iSizeString2)
    {
        ...
        if (((iSizeString2-iEqualEnd == iDiference )) || ((((iSizeString2-iEqualEnd)*2)+iDiference) <= k) || (((iSizeString2-iEqualEnd)*2)-1)==k)
        {
            iResult = 1;  
        }
